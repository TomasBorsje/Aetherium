...
{
	public class Skyshard_Bow : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Skyshard Bow");
			Tooltip.SetDefault("Has a chance to fire a skyshard arrow that bounces back towards you");
		}
		...
		public override void SetDefaults()
		{
			...
			item.UseSound = new Terraria.Audio.LegacySoundStyle(2, 5); // The sound that this item plays when used.
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			if (Main.rand.NextBool(3)) // or ProjectileID.WoodenArrowFriendly
			{
				Vector2 perturbedSpeed2 = new Vector2(speedX, speedY).RotatedByRandom(MathHelper.ToRadians(5));
				Projectile.NewProjectile(position, new Vector2(perturbedSpeed2.X, perturbedSpeed2.Y) * 1.25f, ProjectileType<Skyshard_Arrow>(), (int)(damage * 0.7f), knockBack, player.whoAmI); // or ProjectileID.FireArrow;
			}
